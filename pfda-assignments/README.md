# PFDA- Assignements content

This folder will contain documentation going towards the assignemtns for the programming for data analytics module.

## Assignemnt 1

Brief: Northern bank holdays
